                ...
                <div className="screen-container">
                    {
                        currentScreen === "loading"
                            ?   <div className="loading-screen demo-screen">
                                    <img alt="stitch key logo" className="stitch-key-logo" src={stitchKeyLogo} onClick={() => handleNavigateDemo("dashboard")}/>
                                        ...
                                        <div className="pattern-card">
                                            <div className="pattern-card-image-container">
                                                <img 
                                                    ...
                                                    onClick={() => handleNavigateDemo("reader-weepingangel")}
                                                    src={weepingAngel}
                                                />
                                                <img 
                                        ...
                                        <div className="pattern-card">
                                            <div className="pattern-card-image-container">
                                                <img 
                                                    alt="pattern-image" 
                                                    className="pattern-card-image" 
                                                    onClick={() => handleNavigateDemo("reader-motherofdragons")}
                                                    src={motherOfDragons}
                                                />
